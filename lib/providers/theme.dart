...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff07677f),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff24768e),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff243941),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff5a7079),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff323353),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff696a8d),
      ...
      inverseSurface: Color(0xff2c3134),
      inversePrimary: Color(0xff88d1ec),
      primaryFixed: Color(0xff24768e),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff005d73),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff5a7079),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff425861),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff696a8d),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff515274),
      ...
      surfaceContainerHigh: Color(0xffd9dde0),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff454667),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff454667),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff84cde8),
      ...
      tertiaryContainer: Color(0xffbfbfe7),
      onTertiaryContainer: Color(0xff060726),
